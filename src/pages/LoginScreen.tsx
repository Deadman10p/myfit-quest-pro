...
const LoginScreen: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    const onboarded = localStorage.getItem(`fitai-onboarded-${email}`) === "true";
    setUser({ id: Date.now().toString(), email, onboarded });
    setLoading(false);
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 touch-target bg-secondary border-border"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-10 touch-target bg-secondary border-border"
                aria-label="Password"
